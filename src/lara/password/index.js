    ...
    input: {
        root: ({ props, context, parent }) => ({
            class: [
                ...
                // Shape
                'rounded-full', // Увеличиваем радиус скругления
                'rounded-full', // Добавляем ещё один класс для ещё более закругленных углов
                ...
                'bg-black', // Изменение цвета фона на чёрный
                'border',
                ...
                // States
                {
                    'hover:border-teal-400': !context.disabled && !parent.props.invalid, // Изменение цвета подсветки при наведении
                    'focus:outline-none focus:outline-offset-0 focus:ring focus:ring-teal-400': !context.disabled, // Изменение цвета обводки при фокусировке
